        ...
        <div>
            ...
            <div className="intro">
                <p style={{ color: '#434c5e' }}>
                    Hello, I'm Filip.
                    <br />
                    I'm a M.Sc. Student at Faculty of Engineering LTH. Currently, IT Consult at <a className="link" href="http://www.lunicore.se/" target="_blank" rel="noopener noreferrer">Lunicore.</a>
                    <br />
